...
namespace SocialMediaApi.Tests
{
    public class AuthControllerTests
    {
        ...
        /* Positive Test for Register (Create) - User Successfully Registered */
        [Fact]
        ...
        /* Negative Test for Register (Create) - Email Already Exists */
        [Fact]
        ...
        /* Positive Test for Login (Read) - User Successfully Logged In */
        [Fact]
        ...
        /* Negative Test for Login (Read) - Invalid Credentials */
        [Fact]
        ...
        /* Positive Test for Logout - User Successfully Logged Out */
        [Fact]
        ...
        /* Negative Test for GetUserInfo (Read) - Unauthorized User */
        [Fact]
